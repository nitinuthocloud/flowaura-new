...
<body>
    ...
    <script>
        ...
        const API_URL_NEW = 'sales-api-new.php';
        ...
        const cardConfig = {
            'Total Business': {
                ...
                headers: ['#', 'User ID', 'Customer Name', 'Email', 'Mobile', 'Total Business', 'Total MRR']
            },
            'Active MRR': {
                endpoint: 'business_users',
                queryParams: { item_type: 'include', data_type: 'total' },
        ...
        const fieldMappings = {
            ...
            business_users: {
                ...
                'User ID': function (item) {
                    return item.user_id || item.client_id || item.id || '';
                },
                ...
                'Email': function (item) {
                    return item.email || item.emails || '';
                },
                'Mobile': function (item) {
                    return item.mobile || item.work_number || '';
                },
                'Total Business': function (item) {
        ...
        // async function getDealsCard(data) {
        ...
        //         // stage count
        //         if (deal.deal_stage_id === 'Close Won') {
        //             close_won++;
        //         } else if (deal.deal_stage_id === 'Close Lost') {
        //             close_lost++;
        //         }
        //     });
        ...
        //             total_amount >= 100 ? total_amount.toLocaleString('en-IN') : total_amount,

        //         total_deals,
        //         close_won,
        //         close_lost
        //     };
        //     totalFunnelValue(result);
        //     // console.log("Deals Summary:", result);
